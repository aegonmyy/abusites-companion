// Shared nav icon vocabulary, extracted so BottomTabBar.tsx, HeaderIcons.tsx,
...
export function PastQsIcon({ className }: IconProps) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
...
export function BookmarksIcon({ className }: IconProps) {
  return (
